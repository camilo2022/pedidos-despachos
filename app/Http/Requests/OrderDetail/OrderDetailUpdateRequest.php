...
class OrderDetailUpdateRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        ->where('order_details.id', '<>', $this->route('id'))
    ...
    public function rules()
    {
        $rules = [
            ...
            'product_id' => ['required', 'exists:products,id', 'unique:order_details,product_id,' . $this->route('id') . ',id,order_id,' . $this->input('order_id') . ',color_id,' . $this->input('color_id')],
