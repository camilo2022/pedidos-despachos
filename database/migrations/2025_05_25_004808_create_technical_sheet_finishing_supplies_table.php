...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('technical_sheet_finishing_supplies', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(TechnicalSheet::class)->constrained()->onUpdate('cascade')->onDelete('cascade');
            $table->foreignIdFor(TypeOfSupply::class)->constrained()->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('technical_sheet_finishing_supplies');
    }
};
