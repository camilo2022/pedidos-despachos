...
class OrderDispatchDetailCancelRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'status.in' => 'El detalle de la orden de despacho con referencia ' . $this->input('reference') . ' en el color ' . $this->input('color') . ' no se puede devolver. Los detalles que se pueden devolver son aquellos que esten en los siguientes estados: Pendiente.'
        ];
    }
}
