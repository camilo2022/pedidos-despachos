    ...
    <section class="content">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">REPORTE DE DESPACHOS</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dispatches" class="table table-bordered table-hover dataTable dtr-inline nowrap w-100">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th>USUARIO FILTRADOR</th>
                                            <th>ESTADO FILTRADOR</th>
                                            <th>FECHA FILTRADOR</th>
                                            <th>USUARIO FACTURADOR</th>
                                            <th>FECHA FACTURADOR</th>
                                            <th>CORRERIA</th>
                                        </tr>
                                    </thead>
                                    <tbody>
...
@endsection
@section('script')
    <script src="{{ asset('js/Dashboard/Reports/DataTableIndexDispatches.js') }}"></script>
@endsection
