...
class OrderAssentRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        ...
        $this->merge([
            ...
            'min' => $order->seller_user->zone == 'PERIFERIA' ? 30 : 5,
            'quantity' => $quantity,
            'quota' => $quota,
            'wallet' => $wallet
        ]);
    ...
    public function rules()
    {
        return [
            ...
            'quantity' => ['required', 'integer', 'min:' . $this->input('min')],
    ...
    public function messages()
    {
        return [
            ...
            'quantity.required' => 'La cantidad total de unidades del pedido es requerido.',
            'quantity.min' => 'La cantidad mínima requerida de unidades para asentar el pedido debe ser de :min unidades. La cantidad actual es de ' . $this->input('quantity') . ' unidades.',
