function PendingOrderDispatch(id, status = true) {
    Swal.fire({
        title: '¿Desea devolver la orden de despacho?',
        text: 'La orden de despacho será devuelta.',
        icon: 'warning',
        ...
        if (result.value) {
            $.ajax({
                url: `/Dashboard/Dispatches/Pending`,
                type: 'PUT',
                data: {
            ...
            toastr.info('La orden de despacho seleccionada no fue devuelta.')
        }
    });
}
