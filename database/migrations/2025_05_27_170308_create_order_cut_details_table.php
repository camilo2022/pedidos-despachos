...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_cut_details', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(OrderCut::class)->constrained()->onUpdate('cascade')->onDelete('cascade');
            $table->foreignIdFor(OrderProductionDetail::class)->constrained()->onUpdate('cascade')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('order_cut_details');
    }
};
