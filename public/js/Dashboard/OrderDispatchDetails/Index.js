    ...
    $.each(orderDispatch.order_dispatch_details, function(index, order_dispatch_detail) {
        ...
        switch (order_dispatch_detail.status) {
            case 'Pendiente':
                ...
                break;
            case 'Cancelado':
                body += `<td><span class="badge badge-pill badge-danger"><i class="fas fa-xmark mr-2 text-white"></i>Cancelado</span></td>`;
                break;
            case 'Alistamiento':
                body += `<td><span class="badge badge-pill badge-primary text-white"><i class="fas fa-barcode-read mr-2"></i>Alistamiento</span></td>`;
                break;
            case 'Revision':
                body += `<td><span class="badge badge-pill badge-warning" style="color:white !important;"><i class="fas fa-gear mr-2 text-white"></i>Revision</span></td>`;
                break;
            case 'Empacado':
                body += `<td><span class="badge badge-pill badge-secondary"><i class="fas fa-box-open-full mr-2"></i>Empacado</span></td>`;
                break;
            case 'Facturacion':
                body += `<td><span class="badge badge-pill bg-orange text-white" style="color: white !important;"><i class="fas fa-money-bill mr-2 text-white"></i>Facturacion</span></td>`;
                break;                        
            case 'Despachado':
                body += `<td><span class="badge badge-pill badge-success"><i class="fas fa-share-all mr-2"></i>Despachado</span></td>`;
                break;
            default:
                body += `<td><span class="badge badge-pill badge-info"><i class="fas fa-arrows-rotate mr-2"></i>Pendiente</span></td>`;
                break;
        ...
        body += `<td><span class="badge badge-pill badge-dark">${order_dispatch_detail.date}</span></td>
        ...
        switch (order_dispatch_detail.order_detail.status) {
            ...
            case 'Agotado':
                ...
                break;
            case 'Suspendido':
                body += `<td><span class="badge badge-pill badge-secondary text-white"><i class="fas fa-clock-rotate-left mr-2 text-white"></i>Suspendido</span></td>`;
                break;
            case 'Comprometido':
        ...
        body += `<td><span class="badge badge-pill badge-dark">${order_dispatch_detail.order.dispatch_type}</span></td>
