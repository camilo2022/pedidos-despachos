...
class ProductPOSRequest extends FormRequest
{
    ...
    {
        return [
            'search.required' => 'El campo Codigo de Barras es requerido.',
            'search.boolean' => 'El campo Codigo de Barras debe ser true o false.',
