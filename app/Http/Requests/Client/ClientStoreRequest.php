...
class ClientStoreRequest extends FormRequest
{
    ...
    protected function prepareForValidation()
    {
        $this->merge([
            ...
            'branch_code' => sprintf('%03d', $this->input('branch_code', '1')),
    ...
    public function rules()
    {
        return [
            ...
            'cell_phone_number' => ['nullable', 'min:5', 'max:15'],
            'branch_code' => ['required', 'string', 'size:3', 'unique:clients,branch_code,NULL,id,number_document,' . $this->input('number_document')],
    ...
    public function messages()
    {
        return [
            ...
            'cell_phone_number.min' => 'El campo Numero de telefono del cliente debe tener minimo 5 digitos.',
            'cell_phone_number.max' => 'El campo Numero de telefono del cliente no debe exceder los 15 digitos.',
