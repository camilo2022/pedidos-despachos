...
class OrderAuthorizeRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            Deuda de 1 a 30 días: $' . number_format($this->input('wallet')->one_to_thirty, 0, ',', '.') . '. 
            Deuda de 31 a 60 días: $' . number_format($this->input('wallet')->thirty_one_to_sixty, 0, ',', '.') . '. 
            Deuda de 61 a 90 días: $' . number_format($this->input('wallet')->sixty_one_to_ninety, 0, ',', '.') . '. 
            Deuda de 91 a 120 días: $' . number_format($this->input('wallet')->ninety_one_to_one_hundred_twenty, 0, ',', '.') . '. 
            Deuda de 121 a 150 días: $' . number_format($this->input('wallet')->one_hundred_twenty_one_to_one_hundred_fifty, 0, ',', '.') . '. 
            Deuda de 151 a 180 días: $' . number_format($this->input('wallet')->one_hundred_fifty_one_to_one_hundred_eighty_one, 0, ',', '.') . '. 
            Deuda mayor a 181 días: $' . number_format($this->input('wallet')->eldest_to_one_hundred_eighty_one, 0, ',', '.') . '. 
            Deuda total: $' . number_format($this->input('quota') + $this->input('wallet')->one_to_thirty, 0, ',', '.') . '. 
