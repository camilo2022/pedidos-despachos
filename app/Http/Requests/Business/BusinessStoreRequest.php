...
class BusinessStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'branch' => ['required', 'string', 'unique:businesses,branch', 'max:255'],
            ...
            'letterhead' => ['file', 'mimes:jpeg,jpg,png'],
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'order_footer.required' => 'El campo Correo electronico de notificacion de pedido asentado es requerido.',
            ...
            'letterhead.file' => 'El campo membrete debe ser un archivo.',
            'letterhead.mimes' => 'El campo membrete debe tener una extensión válida (jpeg, jpg, png).'
        ];
    }
}
